...
<div class="mobile-nav">
	...
	<div class="amado-navbar-brand">
		<a href="index.html"><img
			src="${pageContext.servletContext.contextPath}/shop-resources/img/core-img/logo.png"
			alt=""></a>
	</div>
	<!-- Navbar Toggler -->
...
<header class="header-area clearfix">
	...
	<div class="cart-fav-search mb-100">
		<a href="cart.html" class="cart-nav"><img
			...
			alt=""> Cart <span>(0)</span></a> <a href="#" class="fav-nav"><img
			src="${pageContext.servletContext.contextPath}/shop-resources/img/core-img/favorites.png"
			alt=""> Favourite</a> <a href="#" class="search-nav"><img
			src="${pageContext.servletContext.contextPath}/shop-resources/img/core-img/search.png"
			alt=""> Search</a>
	</div>
	<!-- Social Button -->
